...
pdf("FigS1_fits.pdf")
mat<-matrix(data=1:9, nrow=3, ncol=3, byrow=F) 
layout(mat)
## Tmax
par(fig=c(0,0.3,0.7,1), mar=c(0,2,0,0), oma=c(1,4,2,0))
  plot(master[,"coefs_Tmax.b"], col="red", ylab="", xaxt="n", 
       ylim=c(24,32), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
  mtext(expression(paste("Intercept, ", T[z0]~(degree*C))), outer=F, side=2, line=3.5)
  mtext(Tmax.exp, side=3, line=0.3)
  
par(fig=c(0,0.3,0.4,0.7), new=T, mar=c(0,2,0,0), oma=c(1,4,2,0))
  plot(master[,"coefs_Tmax.m"]*1000, ylab="", xaxt="n", 
       ylim=c(-11,-1), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
  mtext(expression(paste("Slope, dT/dz ", (degree*C~km^-1))), outer=F, side=2, line=3.5)
  
par(fig=c(0,0.3,0.1,0.4), new=T, mar=c(0,2,0,0), oma=c(1,4,2,0))
plot(master[,"R2_Tmax"], ylab="", xaxt="n", las=1, cex.axis=1.1)
axis(side=1, at=seq(1910, 2017, by=10), labels=T, tick=T, tcl=-0.3)
mtext(expression("R"^2), outer=F, side=2, line=3.5)

## Tmin
par(fig=c(0.35,0.65,0.7,1), new=T, mar=c(0,2,0,0), oma=c(1,2,2,1))
  plot(master[,"coefs_Tmin.b"], col="blue", ylab="", xaxt="n", las=1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
  mtext(Tmin.exp, side=3, line=0.3)
  
par(fig=c(0.35,0.65,0.4,0.7), new=T, mar=c(0,2,0,0), oma=c(1,2,2,1))
  plot(master[,"coefs_Tmin.m"]*1000, ylab="", xaxt="n", 
       ylim=c(-11,-1), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)

par(fig=c(0.35,0.65,0.1,0.4), new=T, mar=c(0,2,0,0), oma=c(1,2,2,1))
  plot(master[,"R2_Tmin"], ylab="", xaxt="n", 
       ylim=c(0,0.95), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=T, tick=T, tcl=-0.3)

## Tavg
par(fig=c(0.7,1,0.7,1), new=T, mar=c(0,2,0,0), oma=c(1,2,2,4))
  plot(master[,"coefs_Tavg.b"], ylab="", xaxt="n", las=1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
  mtext(Tavg.exp, side=3, line=0.3)
  
par(fig=c(0.7,1,0.4,0.7), new=T, mar=c(0,2,0,0), oma=c(1,2,2,4))
  plot(master[,"coefs_Tavg.m"]*1000, ylab="", xaxt="n", 
       ylim=c(-11,-1), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
  
par(fig=c(0.7,1,0.1,0.4), new=T, mar=c(0,2,0,0), oma=c(1,2,2,4))
  plot(master[,"R2_Tavg"], ylab="", xaxt="n", 
       ylim=c(0,0.95), las=1, cex.axis=1.1)
  axis(side=1, at=seq(1910, 2017, by=10), labels=T, tick=T, tcl=-0.3)
dev.off()
...
mastertr<-cbind(master, MEI, lnrfi, 
              ...
              sqacsh, sqacmh, awnd)
#colnames(mastertr)<-c(colnames(master), colnames(mastertr)[30:38])

## Subset out only the time series for further analyses
all<-list(Tmax0=mastertr[,"master.coefs_Tmax.b"],
          Tmin0=mastertr[,"master.coefs_Tmin.b"],
          Tavg0=mastertr[,"master.coefs_Tavg.b"], #disregard DTR
          sst=mastertr[,"master.indices.sst"],
          lnrfi=mastertr[,"lnrfi"],
          waswind=mastertr[,"master.windcloud.waswind"],
          awnd=mastertr[,"awnd"],
          si10=mastertr[,"master.windcloud.si10"],
          ...
          MEI=mastertr[,"MEI"],
          PDO=mastertr[,"master.indices.pdo"],
          IPO=mastertr[,"master.indices.ipo"],
          NPGO=mastertr[,"master.NPGO"])
...
names(zyp.trend)<-names(all.ns)
  ...
  ##  Decreasing: lnrfi***, waswind*, awnd*, sqmcc***, sqacsh***,sqacmh***, NPGO***
...
MEIplot<-function(xMEI, yaxt, xaxt, xlim){  # provide a time series of MEI
  plot(xMEI, ylab="MEI", ylim=c(-3,3), yaxt=yaxt, xaxt=xaxt, xlim=xlim); abline(0,0)
...
mtext(expression(Detrended~Upwind~SST~(degree*C)), side=2, line=3, cex=0.8)
...
mtext(expression(Detrended~Rainfall~Index), side=2, line=3, cex=0.8)
...
mtext(expression(Detrended~Wind~Speed ~(m~s^-1)), side=2, line=3, cex=0.8)
...
### PDO + Tmax
plot(all.dt.f3[,"PDO"], lwd=2, ylim=c(-1.5, 1.5), yaxt='n', xaxt='n')
abline(0,0)
...
legend("bottom", bty="n", horiz=T,
       ...
       lwd=2, col=c("black", "red"), cex=0.9)
mtext(expression(PDO~Index), side=2, line=3, cex=0.8)
...
###### NPGO ######################
### NPGO + Tmax
plot(all.dt.f3[,"NPGO"], lwd=2, ylim=c(-2, 2), yaxt='n', xaxt='n')
abline(0,0)
axis(side=2, labels=T, tick=T, las=2, cex.lab=0.9, at=c(-1.0,0,1.0))
axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
...
axis(side=4, labels=F, tick=T, tcl=0.3)
legend("bottom", bty="n", horiz=T,
       legend=c("NPGO", dtTmax.exp),
       lwd=2, col=c("black", "red"), cex=0.9)
mtext(text="NPGO", side=2, line=3, cex=0.9)
...
axis(side=4, labels=T, tick=T, las=2)
legend("bottom", bty="n", horiz=T,
       legend=c("NPGO", dtTmin.exp),
       lwd=2, col=c("black","blue"), cex=0.9)

###### IPO ######################
### IPO + Tmax
plot(all.dt.f3[,"IPO"], lwd=2, ylim=c(-1.5, 1.5), yaxt='n', xaxt='n')
abline(0,0)
axis(side=2, labels=T, tick=T, las=2, cex.lab=0.9, at=c(-1.0,0,1.0))
axis(side=1, at=seq(1910, 2017, by=10), labels=F, tick=T, tcl=-0.3)
...
axis(side=4, labels=F, tick=T, tcl=0.3)
legend("bottom", bty="n", horiz=T,
       legend=c("IPO", dtTmax.exp),
       lwd=2, col=c("black", "red"), cex=0.9)
mtext(text="IPO", side=2, line=3, cex=0.9)
...
axis(side=4, labels=T, tick=T, las=2)
legend("bottom", bty="n", horiz=T,
       legend=c("IPO", dtTmin.exp),
       lwd=2, col=c("black","blue"), cex=0.9)

###### MEI ######################
### MEI + Tmax

MEIplot(all$MEI, yaxt="n", xaxt='n', xlim=c(1910, 2017))
axis(2, las=2)
par(new=T)
plot(all.dt.f3[,"Tmax0"], col="red", lwd=2, ylim=c(-0.9, 0.9), 
     yaxt='n', xaxt='n', xlim=c(1910, 2017))
axis(4, labels=F, tick=T, tcl=0.3)
axis(side=1, at=seq(1910, 2017, by=10), labels=T, tick=T, tcl=-0.3)
legend("bottom", legend=c("MEI>0", "MEI<0", NA, dtTmax.exp), bty="n", ncol=2,
       lwd=c(NA,NA,NA, 2), fill=c("pink", "skyblue", NA, NA), 
       border=c("gray30", "gray30", NA, NA), col=c(NA, NA, NA, "red"), cex=.9,
       text.width=20, x.intersp=0.5)

MEIplot(all$MEI, yaxt="n", xaxt='n', xlim=c(1910, 2017))
axis(side=2, labels=F, tick=T, tcl=0.3)
par(new=T)
plot(all.dt.f3[,"Tmin0"], col="blue", lwd=2, ylim=c(-0.9, 0.9), yaxt='n', xaxt='n')
axis(side=4, labels=T, tick=T, las=2)
axis(side=1, at=seq(1910, 2017, by=10), labels=T, tick=T, tcl=-0.3)
legend("bottom", legend=c("MEI>0", "MEI<0", NA, dtTmin.exp), bty="n", ncol=2,
       lwd=c(NA,NA, NA, 2), fill=c("pink", "skyblue", NA, NA), 
       border=c("gray30", "gray30", NA, NA), col=c(NA, NA, NA, "blue"), cex=.9,
       text.width=20, x.intersp=0.5)
...
#############
rs.sst<-all.dt.f3[,"Tmax0"]-all.dt.f3[,"sst"]
plot(rs.sst~all.dt.f3[,"waswind"])
yx<-cbind(rs.sst, all.dt.f3[,"waswind"])
cor(yx, method="kendall", use="pairwise.complete.obs")

rs.lnrfi<-all.dt.f3[,"Tmax0"]-all.dt.f3[,"lnrfi"]
plot(rs.lnrfi~all.dt.f3[,"waswind"])
yx<-cbind(rs.lnrfi, all.dt.f3[,"waswind"])
cor(yx, method="kendall", use="pairwise.complete.obs")

##
rs.sst<-all.dt.f3[,"Tmin0"]-all.dt.f3[,"sst"]
plot(rs.sst~all.dt.f3[,"waswind"])
yx<-cbind(rs.sst, all.dt.f3[,"waswind"])
cor(yx, method="kendall", use="pairwise.complete.obs")

rs.lnrfi<-all.dt.f3[,"Tmin0"]-all.dt.f3[,"lnrfi"]
plot(rs.lnrfi~all.dt.f3[,"waswind"])
yx<-cbind(rs.lnrfi, all.dt.f3[,"waswind"])
cor(yx, method="kendall", use="pairwise.complete.obs")

rs.wind<-all.dt.f3[,"Tmin0"]-all.dt.f3[,"waswind"]
plot(rs.wind~all.dt.f3[,"lnrfi"])
yx<-cbind(rs.wind, all.dt.f3[,"lnrfi"])
cor(yx, method="kendall", use="pairwise.complete.obs")

plot(rs.wind~all.dt.f3[,"sst"])
yx<-cbind(rs.wind, all.dt.f3[,"sst"])
cor(yx, method="kendall", use="pairwise.complete.obs")
